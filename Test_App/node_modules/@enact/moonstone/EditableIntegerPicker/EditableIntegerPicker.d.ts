 ...
 */
  ...
  /**
 * Disables the picker and prevents   
from firing.
 */
  disabled?: boolean;
  /**
...
export class EditableIntegerPickerBase extends React.Component<
  Merge<React.HTMLProps<HTMLElement>, EditableIntegerPickerBaseProps>
> {}
...
export class EditableIntegerPicker extends React.Component<
  Merge<React.HTMLProps<HTMLElement>, EditableIntegerPickerProps>
> {}
