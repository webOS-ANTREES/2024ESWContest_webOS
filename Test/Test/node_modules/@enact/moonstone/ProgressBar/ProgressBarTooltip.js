...
function _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; } // prop-type validator that warns on invalid orientation + position
...
var ProgressBarTooltipBase = exports.ProgressBarTooltipBase = (0, _kind["default"])({
  ...
  propTypes: /** @lends moonstone/ProgressBar.ProgressBarTooltip.prototype */{
     ...
     * @public
     */
    position: validatePosition(_propTypes2["default"].oneOf([
    // horizontal
    'above', 'above before', 'above left', 'above after', 'above right', 'below', 'below left', 'below before', 'below right', 'below after',
    // vertical
