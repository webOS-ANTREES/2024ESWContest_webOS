...
ScrollableBaseNative.propTypes = /** @lends moonstone/UiScrollableNative.ScrollableNative.prototype */{
   ...
   *
   * `'both'` could be only used for {@link Scroller.Scroller|Scroller}.
   *
   * Valid values are:
   * * `'both'`,
   * * `'horizontal'`, and
...
var ScrollableNative = exports.ScrollableNative = /*#__PURE__*/function (_Component2) {
...
ScrollableNative.propTypes = /** @lends moonstone/UiScrollableNative.ScrollableNative.prototype */{
  /**
   * Render function.
   *
   * @type {Function}
