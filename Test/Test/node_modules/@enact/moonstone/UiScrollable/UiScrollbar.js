...
var _UiScrollThumb = _interopRequireDefault(require("./UiScrollThumb"));
var _UiScrollbarModule = _interopRequireDefault(require("./UiScrollbar.module.css"));
...
/**
 * An unstyled base component for a scroll bar. It is used in {@link moonstone/UiScrollable.Scrollable|Scrollable}.
 *
 * @class ScrollbarBase
 ...
 * @private
 */
var ScrollbarBase = exports.ScrollbarBase = /*#__PURE__*/function (_PureComponent) {
...
/**
 * An unstyled scroll bar. It is used in {@link moonstone/UiScrollable.Scrollable|Scrollable}.
 *
 * @class Scrollbar
 * @memberof moonstone/UiScrollable
 * @ui
...
ScrollbarBase.propTypes = /** @lends moonstone/UiScrollable.Scrollbar.prototype */{
  /**
...
ScrollbarBase.defaultProps = {
  ...
  corner: false,
  css: _UiScrollbarModule["default"],
  vertical: true
};
var Scrollbar = exports.Scrollbar = /*#__PURE__*/function (_Component) {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsx)(ScrollbarBase, _objectSpread(_objectSpread({}, this.props), {}, {
        ...
        childRenderer: function childRenderer(_ref) {
          ...
          return /*#__PURE__*/(0, _jsxRuntime.jsx)(_UiScrollThumb["default"], {
            ref: thumbRef,
            vertical: vertical
          }, "thumb");
        }
...
Scrollbar.propTypes = /** @lends moonstone/UiScrollable.Scrollbar.prototype */{
  /**
   * If `true`, the scrollbar will be oriented vertically.
   *
   * @type {Boolean}
