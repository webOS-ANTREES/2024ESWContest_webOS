...
describe('Dropdown', function () {
  test('should have `title`', function () {
    ...
    var actual = (0, _react.within)(_react.screen.getByRole('button')).getByText(title);
  ...
  test('should update when children are removed or added', function () {
    ...
    var lessChildrenActual = _react.screen.getByRole('group').children;
    ...
    var moreChildrenActual = _react.screen.getByRole('group').children;
  ...
  test('should allow members in child object to override injected aria values', function () {
    ...
    var actual = (0, _react.within)(_react.screen.getByRole('group')).getByRole('button');
  ...
  describe('DropdownList', function () {
    test('should include `data` and `selected` in `onSelect` callback', /*#__PURE__*/_asyncToGenerator(function* () {
      ...
      var firstItem = _react.screen.getByRole('group').children[0].children[0];
