...
var _UiRadioDecorator = require("../UiRadioDecorator.js");
...
describe('RadioDecorator', function () {
  ...
  var Controller = (0, _UiRadioDecorator.RadioControllerDecorator)('main');
  ...
  test('should be activated when its prop is true on mount', function () {
    var Component = (0, _UiRadioDecorator.RadioDecorator)({
      prop: 'active'
    }, Item);
