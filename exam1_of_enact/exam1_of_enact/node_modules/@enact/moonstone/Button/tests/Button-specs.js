...
describe('Button', function () {
  ...
  test('should have default `size` \'small\'', function () {
    (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsx)(_Button.ButtonBase, {}));
    var button = _react.screen.getByRole('button');
    var expected = _ButtonModule["default"].small;
    expect(button).toHaveClass(expected);
  });
  ...
  describe('with `color`', function () {
    ...
    test('should not have not \'hasColor\' when no `color` is specified', function () {
      (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsx)(_Button["default"], {
        children: "abc"
      }));
      var button = _react.screen.getByRole('button');
