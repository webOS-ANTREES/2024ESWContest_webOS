 ...
 */
  noAutoClose?: boolean;
  /**
 * Allows the user to move    past the bottom of the expandable
...
export class ExpandableListBase extends React.Component<
  Merge<React.HTMLProps<HTMLElement>, ExpandableListBaseProps>
> {}
...
export class ExpandableList extends React.Component<
  Merge<React.HTMLProps<HTMLElement>, ExpandableListProps>
> {}
