...
var _excluded = ["aria-valuetext", "children", "disabled", "id", "index", "joined", "max", "min", "onSpotlightDisappear", "orientation", "reverse", "spotlightDisabled", "step", "value", "width"];
var _class;
...
var selectDecIcon = selectIcon('decrementIcon', 'arrowlargedown', 'arrowlargeleft');
...
var PickerBase = (_class = /*#__PURE__*/function (_ReactComponent) {
  ...
  function PickerBase(props) {
    ...
    _this.initContainerRef = _this.initRef('containerRef');
  ...
  _createClass(PickerBase, [{
    ...
    value: function initRef(prop) {
      ...
      return function (ref) {
        ...
        if (_this2.props.componentRef) {
          _this2.props.componentRef(ref);
        }
      };
    }
  }, {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsxs)(Component, _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, voiceProps), rest), {}, {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_PickerButton["default"], _objectSpread(_objectSpread({}, voiceProps), {}, {
        ...
        }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_PickerButton["default"], _objectSpread(_objectSpread({}, voiceProps), {}, {
  ...
  return PickerBase;
}(_react.Component), _class.displayName = 'Picker', _class.propTypes = /** @lends moonstone/internal/Picker.Picker.prototype */{
  /**
