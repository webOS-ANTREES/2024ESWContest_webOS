...
describe('SharedStateDecorator Specs', function () {
  test('should provide a set method via context', function () {
    var fn = jest.fn();
    var SetComponent = (0, _SharedStateDecorator["default"])(function () {
    ...
    (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsx)(SetComponent, {}));
  ...
  test('should provide a get method via context', function () {
    var fn = jest.fn();
    var GetComponent = (0, _SharedStateDecorator["default"])(function () {
      return /*#__PURE__*/(0, _jsxRuntime.jsx)(_SharedStateDecorator.SharedState.Consumer, {
        children: function children(value) {
          fn(value.get);
          return null;
    ...
    (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsx)(GetComponent, {}));
    var expected = 'function';
    var actual = typeof fn.mock.calls[0][0];
    expect(actual).toBe(expected);
  });
  test('should provide a delete method via context', function () {
    var fn = jest.fn();
    var DeleteComponent = (0, _SharedStateDecorator["default"])(function () {
      return /*#__PURE__*/(0, _jsxRuntime.jsx)(_SharedStateDecorator.SharedState.Consumer, {
        children: function children(value) {
          fn(value["delete"]);
          return null;
    ...
    (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsx)(DeleteComponent, {}));
    var expected = 'function';
    var actual = typeof fn.mock.calls[0][0];
    expect(actual).toBe(expected);
  });
