...
var MediaButton = (0, _util.onlyUpdateForProps)(_IconButton["default"], ['children', 'className', 'color', 'disabled', 'flip', 'onClick', 'spotlightDisabled']);
  ...
  render: function render(_ref7) {
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsxs)(OuterContainer, _objectSpread(_objectSpread({}, rest), {}, {
      ...
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
        ...
        children: /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
          ...
          children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(Container, {
            ...
            children: [noJumpButtons ? null : /*#__PURE__*/(0, _jsxRuntime.jsx)(MediaButton, {
              ...
              children: jumpBackwardIcon
            }), noRateButtons ? null : /*#__PURE__*/(0, _jsxRuntime.jsx)(MediaButton, {
              ...
              size: "large",
              spotlightDisabled: spotlightDisabled,
              children: paused ? playIcon : pauseIcon
            }), noRateButtons ? null : /*#__PURE__*/(0, _jsxRuntime.jsx)(MediaButton, {
        ...
        children: [rightComponents, (0, _util2.countReactChildren)(children) ? /*#__PURE__*/(0, _jsxRuntime.jsx)(MediaButton, {
...
var MediaControlsDecorator = exports.MediaControlsDecorator = (0, _hoc["default"])(function (config, Wrapped) {
  var MediaControlsDecoratorHOC = /*#__PURE__*/function (_Component) {
    ...
    _createClass(MediaControlsDecoratorHOC, [{
      ...
      value: function componentDidMount() {
        this.calculateMaxComponentCount((0, _util2.countReactChildren)(this.props.leftComponents), (0, _util2.countReactChildren)(this.props.rightComponents), (0, _util2.countReactChildren)(this.props.children));
      ...
      value: function componentDidUpdate(prevProps, prevState) {
        ...
        var leftCount = (0, _util2.countReactChildren)(prevProps.leftComponents),
          rightCount = (0, _util2.countReactChildren)(prevProps.rightComponents),
          childrenCount = (0, _util2.countReactChildren)(prevProps.children);
        if ((0, _util2.countReactChildren)(this.props.leftComponents) !== leftCount || (0, _util2.countReactChildren)(this.props.rightComponents) !== rightCount || (0, _util2.countReactChildren)(this.props.children) !== childrenCount) {
  ...
  MediaControlsDecoratorHOC.propTypes = /** @lends moonstone/VideoPlayer.MediaControlsDecorator.prototype */{
    /**
