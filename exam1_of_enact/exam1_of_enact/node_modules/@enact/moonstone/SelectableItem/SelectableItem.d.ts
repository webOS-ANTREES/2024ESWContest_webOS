...
/**
 * Renders an    with a circle icon, by default.
 */

export class SelectableItemBase extends React.Component<
  Merge<React.HTMLProps<HTMLElement>, SelectableItemBaseProps>
> {}
...
export class SelectableItem extends React.Component<
  Merge<React.HTMLProps<HTMLElement>, SelectableItemProps>
> {}
