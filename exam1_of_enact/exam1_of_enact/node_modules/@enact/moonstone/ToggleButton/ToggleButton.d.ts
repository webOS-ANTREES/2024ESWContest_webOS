...
/**
 * A stateless    that can be toggled by changing its
 `selected`  property.
 */

export class ToggleButtonBase extends React.Component<
  Merge<React.HTMLProps<HTMLElement>, ToggleButtonBaseProps>
> {}

export interface ToggleButtonProps
  extends Merge<ToggleButtonBaseProps, ui_Toggleable_ToggleableProps> {}
/**
 * A toggleable button.
 * 
...
export class ToggleButton extends React.Component<
  Merge<React.HTMLProps<HTMLElement>, ToggleButtonProps>
> {}
