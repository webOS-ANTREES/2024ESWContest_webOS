...
var _Item = _interopRequireDefault(require("@enact/ui/Item"));
var _UiSlotItem = _interopRequireDefault(require("../../UiSlotItem"));
var _UiToggleItem = _interopRequireWildcard(require("../UiToggleItem"));
...
var SlottedItem = /*#__PURE__*/(0, _react2.forwardRef)(function (props, ref) {
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_UiSlotItem["default"], _objectSpread(_objectSpread({}, props), {}, {
...
describe('ToggleItem Specs', function () {
  test('should call onToggle, onClick, or both when clicked', function () {
    ...
    (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsx)(_UiToggleItem["default"], {
  ...
  test('should call onClick when clicked', /*#__PURE__*/_asyncToGenerator(function* () {
    ...
    (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsx)(_UiToggleItem.ToggleItemBase, {
      component: SlottedItem,
      iconComponent: CustomIcon,
      onClick: handleClick,
