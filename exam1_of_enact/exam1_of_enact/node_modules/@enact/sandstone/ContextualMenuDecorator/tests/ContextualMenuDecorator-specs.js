...
describe('ContextualMenuDecorator Specs', function () {
  ...
  test('should emit onClose event when clicking outside the contextual menu', /*#__PURE__*/_asyncToGenerator(function* () {
    ...
    yield user.click(floatingLayerScrim);
    expect(handleClose).toHaveBeenCalled();
  }));
  test('should not close menu when clicking outside if noAutoDismiss is true', /*#__PURE__*/_asyncToGenerator(function* () {
    var handleClose = jest.fn();
    var user = _userEvent["default"].setup();
    (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsx)(Root, {
      "data-testid": "contextualMenu",
  ...
  test('should wrap content in Scroller component if menuItem length exceeds MAX_VISIBLE_MENU_ITEMS', function () {
    var moreItems = new Array(8).fill().map(function (i, index) {
      return "Option ".concat(index + 1);
    });
    (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsx)(Root, {
      children: /*#__PURE__*/(0, _jsxRuntime.jsx)(ContextualButton, {
    ...
    var scroller = _react.screen.getByRole('list').parentElement;
    var expected = 'scroller';
